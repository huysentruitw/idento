...
namespace Idento.Web.Extensions
{
    public static class EnumExtensions
    {
        ...
        /// </summary>
        private static readonly Dictionary<Guid, Dictionary<string, SelectListGroup>> ListGroupCache = new Dictionary<Guid, Dictionary<string, SelectListGroup>>();
        /// <summary>
