...
namespace Idento.Web.ManagerUI.LoginProviders.Models
{
    public class EditOrCreate : IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            var groupName = model.Provider.GetDisplayGroupName();
            switch (groupName)
            {
                case LoginProviderGroupNames.OAuth2:
                    ...
                    break;
                case LoginProviderGroupNames.WsFederation:
